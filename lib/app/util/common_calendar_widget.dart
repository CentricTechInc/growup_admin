...
class CommonCalendarWidget extends StatefulWidget {
  ...
  @override
  CommonCalendarWidgetState createState() => CommonCalendarWidgetState();
}

class CommonCalendarWidgetState extends State<CommonCalendarWidget>
  ...
  // final Animatable<Color> _arrowColorTween = ColorTween(
  //   begin: const Color(0x00FFA68A),
  //   end: const Color(0xffFFA68A),
  // ).chain(_easeInTween) as Animatable<Color>;

  /// Color tween for expand_less icon
  // final Animatable<Color> _monthColorTween =
  //     ColorTween(begin: const Color(0xffEC520B), end: const Color(0x00EC520B)).chain(_easeInTween) as Animatable<Color>;
  ...
  void initState() {
    ...
    // _arrowColor = _controller
    //     .drive(_arrowColorTween);
    _iconTurns = _controller.drive(_halfTween.chain(_easeInTween));
    // _monthColor = _monthController.drive(_monthColorTween);
                    ...
                    children: [
                      Material(
                        ...
                        child: IconButton(
                          ...
                          splashRadius: _expanded ?? false ? 15.0 : 0.001,
                          icon: AnimatedBuilder(
                            animation: AlwaysStoppedAnimation<Color>(Colors.transparent),
